...
namespace TreeCollections
{
    public class BsTreeR : ITree
    {
        ...
        //private Node DeleteNode(ref Node node, int val)
        //{
        //    if (node == null)
        //        return node;
        ...
        //    if (val < node.val)
        //    {
        //        node.left = DeleteNode(ref node.left, val);
        //    }
        //    else if (val > node.val)
        //    {
        //        node.right = DeleteNode(ref node.right, val);
        //    }
        //    //else if (node.left != null && node.right != null)
        //    //{
        //    //    node.val = Min(node.right).val;
        //    //    node.right = DeleteNode(ref node.right, node.val);
        //    //}
        //    //else
        //    //{
        //    //    if (node.left != null)
